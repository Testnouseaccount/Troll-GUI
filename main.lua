...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "Created with Rayfield",
   LoadingSubtitle = "by RedSuperLion",
   ...
   KeySettings = {
      Title = "TROLL Gui | Key",
      Subtitle = "Your Key",
      Note = "Go to the Pastebin link https://pastebin.com/raw/KwNA0Mq0", -- Use this to tell the user how to get a key
      FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://pastebin.com/raw/KwNA0Mq0"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})

local MainTab = Window:CreateTab("The basic Trolling", nil)
local Section = MainTab:CreateSection("Main Section")
local SecondTab = Window:CreateTab("Crazy Level", nil)
local SecondSection = SecondTab:CreateSection("Involves crashing servers!")
local ThirdTab = Window:CreateTab("Misc", nil)
local ThirdSection = ThirdTab:CreateSection("You can get other things!")

local Button = MainTab:CreateButton({
   Name = "Fling on Touch Script",
   Callback = function()
...
local Button = SecondTab:CreateButton({
   Name = "Kick all Script",
   Callback = function()
    for _, Players in game.Players:GetPlayers() do Players:Kick("Bye loser") end
   end,
})
